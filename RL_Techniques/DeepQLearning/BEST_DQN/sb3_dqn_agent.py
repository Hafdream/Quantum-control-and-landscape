...
def train_agent(env, total_time_steps, lr, exploration_fraction, weights_path, verbose):
    ...
    agent = sb3.DQN('MlpPolicy', env, policy_kwargs=dict(net_arch=custom_net_arch), train_freq=(100, "step"), gamma=0.15, verbose=verbose, learning_rate=lr, exploration_fraction=exploration_fraction)
...
if __name__ == "__main__":
    for zz in [4]:  # [2, 3, 4, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50]:
        ...
        weights_path = "./dqn_agent_4param_22.zip"
